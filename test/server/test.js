...
describe('Message', function () {
        it('should load the messages messages', function () {
                assert.notEqual(null, messages);
        });
        it('should be able to add a new message and return id', function () {
                let message = { message: '1' };
        ...
        describe('Check adding users functionality:', function () {
                ...
                it('Should add a new user named Russell Crowe', function (done) {
                        ...
                        chai.request('http://localhost:9098')
                                ...
                                .end(function (err, res) {
                                        ...
                                        assert.equal(messages.Babble.userCount, 1, "Error: test has failed - counter isn't right");
                                        assert.equal((messages.Babble.users).includes("Russell Crowe"), true, "Error: test has failed - name Russell Crowe doesn't exist");
                                        done();
                                });
                ...
                it('Should add a new user named Joaquin Phoenix', function (done) {
                        ...
                        chai.request('http://localhost:9098')
                                ...
                                .end(function (err, res) {
                                        expect(res).to.have.status(200);
                                        assert.equal(messages.Babble.userCount, 2, "Error: test has failed - counter isn't right");
                                        assert.equal((messages.Babble.users).includes("Joaquin Phoenix"), true, "Error: test has failed - name Joaquin Phoenix doesn't exist");
                                        done();
                                });
                ...
                it('Should add a new user named Oliver Reed', function (done) {
                        ...
                        chai.request('http://localhost:9098')
                                ...
                                .end(function (err, res) {
                                        expect(res).to.have.status(200);
                                        assert.equal(messages.Babble.userCount, 3, "Error: test has failed - counter isn't right");
                                        assert.equal((messages.Babble.users).includes("Joaquin Phoenix"), true, "Error: test has failed - name Joaquin Phoenix doesn't exist");
                                        done();
                                });
                ...
                it('Should add a new user named Annonymous', function (done) {
                        ...
                        chai.request('http://localhost:9098')
                                ...
                                .end(function (err, res) {
                                        expect(res).to.have.status(200);
                                        assert.equal(messages.Babble.userCount, 4, "Error: test has failed - counter isn't right");
                                        assert.equal((messages.Babble.users).includes("Annonymous"), true, "Error: test has failed - name Annonymous doesn't exist");
                                        done();
                                });
                ...
                it('Should remove a user named Joaquin Phoenix', function (done) {
                        ...
                        chai.request('http://localhost:9098')
                                ...
                                .end(function (err, res) {
                                        expect(res).to.have.status(200);
                                        assert.equal(messages.Babble.userCount, 3, "Error: test has failed - counter isn't right");
                                        assert.equal((messages.Babble.users).includes("Joaquin Phoenix"), false, "Error: test has failed - name Joaquin Phoenix doesn't exist");
                                        done();
                                });
                ...
                it('Should add a new message', function (done) {
                        ...
                        chai.request('http://localhost:9098')
                                ...
                                .send({
                                        ...
                                        expect(res).to.have.status(200);
                                        assert.equal(Babble.messages.length, 1, "Error: test has failed - message counter isn't right");
                                        done();
                                });
                ...
                it('Should add another new message', function (done) {
                        ...
                        chai.request('http://localhost:9098')
                                ...
                                .send({
                                        ...
                                        expect(res).to.have.status(200);
                                        assert.equal(Babble.messages.length, 2, "Error: test has failed - message counter isn't right");
                                        done();
                                });
